      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 md:order-1">
            ...
            <p className="text-lg md:text-xl mb-6 uppercase tracking-[0.2em] font-light" style={{ color: '#8B5CF6' }}>
          ...
          <div className="order-1 md:order-2">
            <div className="relative aspect-[9/16] md:aspect-video rounded-lg overflow-hidden shadow-2xl group">
              ...
              <div className="absolute bottom-4 right-4 z-10 flex gap-2 group-hover:opacity-100 opacity-0 transition-opacity">
                ...
                <button
                  onClick={toggleMute}
                  className="flex items-center justify-center w-12 h-12 bg-white/80 hover:bg-white backdrop-blur-sm rounded-full transition-all text-black"
